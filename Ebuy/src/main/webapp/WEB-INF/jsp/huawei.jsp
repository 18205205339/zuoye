...
<div class="main-menu-area hidden-xs hidden-sm">
	...
	<div class="container">
			<div class="products">
					<h2 class=" products-in">华为</h2>
					<div class=" top-products">
						<div class="col-md-3 md-col">
						<c:forEach items="${requestScope.huawei_list }" var="a">
							<div class="col-md">
								...
								<div class="top-content">
									<h5><a href="single.html">华为p10</a></h5>
									<div class="white">
										<p>${a.price }</p>
										<p><a href="product.action?id=${a.id }" class="btn btn-warning" role="button"> 商品详情</a></p>
