					...
					<div class="panel-heading">
						<div class="row">
							<div class="text-center">
                            	<p><strong>你正在修改密码，请记住你修改后的密码！</strong></p> 
							</div>
						</div>
						<hr>
					</div>
		  	 ...
		  	 <div class="col-md-12 ">
		  	     <div class="row">
		  	            <div class="form-group">
                           ...
                           <div class="col-md-9">
                                   <input type="text" name="loginname" id="loginname" tabindex="1" class="form-control" placeholder="请输入你的登录名" value="">
                           </div> 
		   		        </div>
						<div class="form-group">
                           <div class="col-md-3 ">  新密码：</div>
                           <div class="col-md-9">
                                   <input type="text" name="password" id="password" tabindex="1" class="form-control" placeholder="请输入你的新密码" value="">
                           </div> 
		   		        </div>
		   		        <div class="form-group">
                           <div class="col-md-3 ">  再次确认新密码：</div>
                           <div class="col-md-9">
                                   <input type="text" name="password" id="password" tabindex="1" class="form-control" placeholder="请再次输入你的新密码" value="">
                           </div> 
		   		        </div>
				        <div class="form-group">
							<div class="row">
