					...
					<div class="panel-heading">
						<div class="row">
							<div class="text-center">
                            	<p><strong>恭喜您成功找回密码，原密码如下，若希望修改密码，点击下方的修改密码即可：</strong></p> 
							</div>
						</div>
						<hr>
					</div>
				        ...
				        <div class="form-group">
							<div class="row">
								<div class="col-sm-5 col-sm-offset-4">
									<div class="col-md-4 col-md-offset-2"><a class="btn btn-warning btn-lg" href="loginForm" role="button">账号登陆</a></div>
								</div>
							</div>
						</div>
						<div class="form-group">
