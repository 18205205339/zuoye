...
<div class="main-menu-area hidden-xs hidden-sm">
	 ...
	 <div class="container">
			<div class="products">
					<h2 class=" products-in">oppo</h2>
					<div class=" top-products">
						<div class="col-md-3 md-col">
						<c:forEach items="${requestScope.oppo_list }" var="n">
							<div class="col-md">
								 <div class="thumbnail"> <img src="images/${n.image }" alt="Thumbnail Image 1" class="img-responsive">
								<div class="compare">
									<span>查看</span>
								</div>	
								<div class="top-content">
									<h5><a href="single.html">oppo系列</a></h5>
									<div class="white">
										<p>${n.price }</p>
										<p><a href="product.action?id=${n.id }" class="btn btn-warning" role="button"> 商品详情</a></p>
